    ...
    implements IMobs
{
    ...
    {
        if(field_770_c > 1 && canEntityBeSeen(entityplayer) && (double)getDistanceToEntity(entityplayer) < 0.59999999999999998D * (double)field_770_c && entityplayer.attackEntityFrom(this, field_770_c))
        {
