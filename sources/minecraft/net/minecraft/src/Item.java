...
public class Item
{
    ...
    static 
    {
        ...
        bucketWater = (new ItemBucket(70, Block.waterStill.blockID)).func_20010_a(11, 4).func_20011_a("bucketWater");
        bucketLava = (new ItemBucket(71, Block.lavaStill.blockID)).func_20010_a(12, 4).func_20011_a("bucketLava");
