...
import net.minecraft.cheat.impl.render.FullBright;
    ...
    implements IBlockAccess
{
    ...
    {
        int k;
        for(k = 63; !func_20084_d(i, k + 1, j); k++) { }
    ...
    public Vec3D func_4079_a(Entity entity, float f)
    {
        ...
        float f3 = (float)func_4075_a().func_4072_b(i, j);
        int k = func_4075_a().func_4073_a(i, j).getSkyColorByTemp(f3);
            ...
            boolean flag)
    {
        ...
        if(flag)
        {
            ...
            {
                MetadataChunkBlock metadatachunkblock = (MetadataChunkBlock)field_1051_z.get(field_1051_z.size() - k2 - 1);
    ...
    public void tick()
    {
        ...
        if(Client.i.cheatList.getCheat(FullBright.class).isToggled()) {
